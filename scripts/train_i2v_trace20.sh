...
# high noise
CUDA_VISIBLE_DEVICES=6 accelerate launch --num_cpu_threads_per_process 1 --mixed_precision bf16 /mnt/cfs/jj/musubi-tuner/src/musubi_tuner/wan_train_network.py \
    ...
    --dataset_config /mnt/cfs/jj/musubi-tuner/my_config/peel_it_i2v_meta_trace20.toml \
    --flash_attn \
    ...
    --output_dir /mnt/cfs/jj/musubi-tuner/peel_it_outputs_high_noise_trace20 --output_name peel_it-of-lorac \
    ...
    --lr_scheduler_min_lr_ratio 0.433 \
    --min_timestep 875 \
    --max_timestep 1000 \
