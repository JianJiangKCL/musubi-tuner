...
## baby bee
CUDA_VISIBLE_DEVICES=4 python /mnt/cfs/jj/musubi-tuner/wan_cache_latents.py --dataset_config /mnt/cfs/jj/musubi-tuner/my_config/babybee_i2v_meta_trace7.toml --vae /mnt/cfs/jj/ckpt/Wan2.2-I2V-A14B/Wan2.1_VAE.pth --vae_dtype bfloat16 --batch_size 180 --num_workers 8 --i2v

CUDA_VISIBLE_DEVICES=4 python /mnt/cfs/jj/musubi-tuner/wan_cache_text_encoder_outputs.py --dataset_config /mnt/cfs/jj/musubi-tuner/my_config/babybee_i2v_meta_trace7.toml --t5 /mnt/cfs/jj/ckpt/Wan2.2-I2V-A14B/models_t5_umt5-xxl-enc-bf16.pth  --batch_size 128 
