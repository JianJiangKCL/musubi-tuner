...
CUDA_VISIBLE_DEVICES=6 python /mnt/cfs/jj/musubi-tuner/src/musubi_tuner/wan_generate_video.py \
    ...
    --task i2v-A14B \
    --prompt "A realistic sticker of a woman is peeled off a surface vertically, revealing the flat background underneath and emphasizing the illusion of depth." \
    --video_size 320 480 \
    --video_length 81 \
    ...
    --attn_mode flash2 \
    --lora_weight /mnt/cfs/jj/musubi-tuner/peel_it_outputs_high_noise_frame81_uniform/peel_it-of-lorac-000050.safetensors \
    --image_path /mnt/cfs/jj/musubi-tuner/test_i2v_outputs/shang.jpg
