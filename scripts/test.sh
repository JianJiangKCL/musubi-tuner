...
CUDA_VISIBLE_DEVICES=7 python /mnt/cfs/jj/musubi-tuner/src/musubi_tuner/wan_generate_video.py \
    ...
    --t5 /mnt/cfs/jj/ckpt/Wan2.2-I2V-A14B/models_t5_umt5-xxl-enc-bf16.pth \
    --task i2v-A14B \
    --prompt "A hand peels a realistic 3D sticker of the main object off a flat surface，revealing the flat background underneath and emphasizing the illusion of depth." \
    --video_size 320 480 \
    --video_length 101 \
    --vae /mnt/cfs/jj/ckpt/Wan2.2-I2V-A14B/Wan2.1_VAE.pth \
    --vae_cache_cpu \
    ...
    --lora_weight_high_noise /mnt/cfs/jj/musubi-tuner/peel_it_outputs_high_noise_trace20/peel_it-of-lorac.safetensors \
    --lora_weight /mnt/cfs/jj/musubi-tuner/peel_it_outputs_high_noise_trace20/peel_it-of-lorac.safetensors 
